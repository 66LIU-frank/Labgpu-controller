...
const translations = {{
  ...
  "Go to Train": "进入训练页",
  "Open Train after saving at least one server.": "保存至少一台服务器后即可进入训练页。",
  "Create groups": "创建分组",
  ...
  "and save it to": "并保存到",
  "For a new student setup, fill the basics below. LabGPU can add the SSH alias to": "新用户配置时，填写下面这些基础信息。LabGPU 可以把 SSH alias 追加到",
  ...
  "Shared account": "共享账号",
  "Shared Linux account": "共享 Linux 账号",
  "Stop own process": "停止自己的进程",
  "Allow stop own process": "允许停止自己的进程",
  "HostName": "主机名",
  "User": "用户",
  "Port": "端口",
  "Probe": "探测",
  ...
  "No providers found.": "没有找到 provider。",
