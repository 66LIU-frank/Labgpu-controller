...
class DashboardPagesTest(unittest.TestCase):
    def test_gpus_page_and_filter(self):
        ...
        self.assertIn("ssh-provider-select", html)
    ...
    def test_providers_page_shows_non_secret_ccswitch_state(self):
        ...
        self.assertNotIn("<h2>Remote Launchers</h2>", html)
        self.assertNotIn("<h2>Recent Remote Launches</h2>", html)
        ...
        self.assertIn("Claude/Codex Proxy Tunnel may use the selected CC Switch provider key inside the local gateway only", html)
