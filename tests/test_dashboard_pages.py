...
class DashboardPagesTest(unittest.TestCase):
    def test_gpus_page_and_filter(self):
        ...
        self.assertIn("My Runs", html)
        self.assertIn("My GPU Processes", html)
        self.assertIn("python train.py", html)
        ...
        self.assertIn('value="remote_write"', html)
        self.assertNotIn('value="remote_write" disabled', html)
        self.assertIn("Remote Config Override", html)
        self.assertIn("backs up remote config", html)
        self.assertIn("Network Tunnel", html)
        self.assertIn("ssh-network-proxy-enabled", html)
        self.assertIn("ssh-network-local-port", html)
        self.assertIn("ssh-network-remote-port", html)
        self.assertIn("ssh-network-scheme", html)
        self.assertIn("This does not proxy SSH itself", html)
        ...
        self.assertIn("Real provider keys stay local", html)
    ...
    def test_servers_and_alerts_pages(self):
        ...
        self.assertIn('href="/groups"', server_html)
    ...
    def test_providers_page_shows_non_secret_ccswitch_state(self):
        ...
        self.assertIn("AI Config Console", html)
        self.assertIn("App Status", html)
        self.assertIn("Remote Launchers", html)
        self.assertIn("Provider Routing", html)
        self.assertIn("Secret Boundary", html)
        self.assertIn("Proxy Tunnel", html)
        self.assertIn("Remote Config Override", html)
        self.assertIn("Recent Remote Launches", html)
        self.assertIn("Choose GPU/server", html)
        self.assertIn("Pick app/provider", html)
        ...
        self.assertIn("temporary session tokens", html)
        self.assertIn("Provider choices", html)
        self.assertIn("127.0.0.1:15721", html)
        self.assertIn("127.0.0.1:15722", html)
        self.assertIn("<strong>TCP</strong>", html)
        self.assertIn("listening", html)
        self.assertIn("Provider: <strong>PackyCode</strong>", html)
        self.assertIn("remote launcher", html)
        self.assertIn("Real provider keys are not copied to servers", html)
        self.assertIn("Never stores or displays real provider secrets", html)
    ...
    def test_settings_page_lists_ssh_hosts(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertNotIn("<h2>Server Groups</h2>", html)
            self.assertIn("Group", html)
            self.assertIn("Write to SSH config", html)
            self.assertIn("AI PATH entries", html)
            self.assertIn("Claude command", html)
            self.assertIn("Codex command", html)
