...
class AISessionTest(unittest.TestCase):
    def test_build_ai_ssh_command_for_claude_proxy_tunnel(self):
        ...
        self.assertIn("unset ANTHROPIC_AUTH_TOKEN CLAUDE_CODE_OAUTH_TOKEN", remote)
        self.assertIn('export ANTHROPIC_API_KEY="$LABGPU_AI_SESSION_TOKEN"', remote)
    ...
    def test_build_ai_ssh_command_for_codex_proxy_tunnel(self):
        ...
        self.assertIn("OPENAI_BASE_URL=http://127.0.0.1:27183/v1", remote)
        ...
        self.assertIn("model_provider", remote)
        self.assertIn("base_url", remote)
        self.assertIn("wire_api", remote)
