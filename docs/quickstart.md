...
The main UI is grouped around Home, Train, Servers, AI Sessions, and Settings. Home still summarizes recommended GPUs, current runs, problems, and saved servers.
